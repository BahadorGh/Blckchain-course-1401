...
contract CORTANA is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x823b9082a418c864827FBD0a630E7d91C555bc12;
    ...
    uint256 public numTokensSellToAddToLiquidity = 50000000000 * 10**18;
    ...
    function _transfer(
        ...
        if (
            ...
            //add liquidity and send busd to marketing address
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        // combine the Liquidity and marketing fees
        ...
        swapTokensForBUSD(tokensForMarketing);
    ...
    function setNumTokensSellToAddToLiquidity(uint256 newAmt) external onlyOwner() {
        numTokensSellToAddToLiquidity = newAmt * (10**18);
    }
